...
export const env = {
  ...
  ipfsApiUrl: getEnv('VITE_IPFS_API_URL', 'https://ipfs.io'),
  githubApiUrl: getEnv('VITE_GITHUB_API_URL', 'https://api.github.com'),
  linkedinApiUrl: getEnv('VITE_LINKEDIN_API_URL', 'https://api.linkedin.com'),
} as const
